function timeFrequencyFeaturesFile = gearboxFileTimeFrequencyFeatures(signal_channels, sampleFrequency, segment_length, overlap, decimateFactor, channelDescription)
    ...
    parfor seg = 1:num_segments
        ...
        timeFrequencyFeatures = extractTimeFrequencyFeatures(segment, sampleFrequency, channelDescription);
        
        % Append the features to timeFeaturesFile
        timeFrequencyFeaturesFile = [timeFrequencyFeaturesFile; timeFrequencyFeatures];  
    end
end