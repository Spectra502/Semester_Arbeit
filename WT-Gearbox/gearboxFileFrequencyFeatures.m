function frequencyFeaturesFile = gearboxFileFrequencyFeatures(signal_channels, sampleFrequency, segment_length, overlap, decimateFactor, channelDescription)
    ...
    parfor seg = 1:num_segments
        ...
        frequencyFeatures = extractFrequencyFeatures(segment, sampleFrequency, channelDescription);
        
        % Append the features to timeFeaturesFile
        frequencyFeaturesFile = [frequencyFeaturesFile; frequencyFeatures];  
    end
end